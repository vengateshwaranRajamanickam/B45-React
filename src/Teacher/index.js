...
export default function Student(){
    ...
    //                         <>
    //                             < Teachercard key={index} data={value} add={context.TeacherShowdetail} />
    //                             <br />
    //                         </>
    //                     )
    //                 }
    ...
    //                     < Teacherdetail key={index} details={value} reset={context.TeacherShowdetail} deletefile={context.TeacherDeletedetail}  Updatedetail={context.TeacherUpdatedetail}/>
    //                 ))
    //             }
    //             </Col>
    //         </Row>
